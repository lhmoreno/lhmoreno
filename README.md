...
Programming is more than creating software, it is having fun in the process. <br/>
Never stop loving what you do and you will always be happy.

- Currently working as a freelancer.
- Reactjs, Node.js and React Native dominated.
- Focused on never stop learning.
- In search of new opportunities.
- Testing things is my passion.
